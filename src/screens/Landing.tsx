...
export function Landing({ onStart }: { onStart: () => void }) {
  return (
    <div className="step-section max-w-180 mx-auto pt-16 px-12 pb-20">
      {/* Wordmark */}
      <div className="mb-14">
        <Wordmark size="lg" />
      </div>
      ...
      <div className="mb-12">
        ...
        <p className="font-sans-kr text-base text-navy/62 leading-[1.8] max-w-120">
      ...
      <button
        className="btn-primary text-[15px] py-3.25 px-9"
        onClick={onStart}
      >
        소명서 작성 시작하기
      </button>
