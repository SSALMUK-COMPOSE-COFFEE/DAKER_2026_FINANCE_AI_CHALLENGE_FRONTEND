...
export function OnboardingModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-[20px] w-full max-w-195 overflow-hidden relative shadow-[0_24px_64px_rgba(20,28,38,0.18)]">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="flex min-h-120">
          {/* Left text */}
          <div className="flex-[0_0_42%] pt-13 px-10 pb-9 flex flex-col justify-center">
