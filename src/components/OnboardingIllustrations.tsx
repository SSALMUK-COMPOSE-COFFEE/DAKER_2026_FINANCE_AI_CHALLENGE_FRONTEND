  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 420 280" fill="none" className="block">
      ...
      <g transform="translate(88,108) rotate(-30)">
        <rect x="0" y="0" width="8" height="22" rx="1.5" fill={COLORS.warm} opacity="0.7" />
      ...
      <line x1="313" y1="82" x2="322" y2="86" stroke={COLORS.blue} strokeWidth="1.5" strokeLinecap="round" />
      ...
      <text x="313" y="218" textAnchor="middle" fontSize="11" fontFamily="'Noto Sans KR', sans-serif" fill={COLORS.blue} fontWeight="600">약 15분</text>

      {/* Labels */}
      <text x="107" y="250" textAnchor="middle" fontSize="11" fontFamily="'Noto Sans KR', sans-serif" fill="rgba(16,35,63,0.45)">직접 작성할 때</text>
      <text x="313" y="250" textAnchor="middle" fontSize="11" fontFamily="'Noto Sans KR', sans-serif" fill={COLORS.blue}>풀림 사용 시</text>
    </svg>
  )
}
...
export function SlideIllustration2() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 420 280" fill="none" className="block">
      ...
      <path d="M185 115 L185 138M178 122 L185 115 L192 122" stroke={COLORS.blue} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="176" y="138" width="18" height="3" rx="1.5" fill={COLORS.blue} opacity="0.5" />
      <text x="185" y="200" textAnchor="middle" fontSize="10.5" fontFamily="'Noto Sans KR', sans-serif" fill={COLORS.blue}>AI 분석</text>
      ...
      <text x="331" y="215" textAnchor="middle" fontSize="10.5" fontFamily="'Noto Sans KR', sans-serif" fill={COLORS.blue}>소명서 완성</text>
